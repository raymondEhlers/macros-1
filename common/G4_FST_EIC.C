...
*/  
    if(Enable::AI_TRACKINGGEO) make_LANL_FST_station(Form("EST_%i", i), g4Reco, -1*bkwd_z[i], bkwd_rmin[i], bkwd_rmax[i], 35 * um, 10e-4);  //cm
    else make_LANL_FST_station(Form("EST_%i", i), g4Reco, -1*bkwd_z_np[i], bkwd_rmin_np[i], bkwd_rmax_np[i], 35 * um, 10e-4);  //cm
  }
...
*/
    if(Enable::AI_TRACKINGGEO) make_LANL_FST_station(Form("FST_%i", i), g4Reco, fwd_z[i], fwd_rmin[i], fwd_rmax[i], 35 * um, 10e-4);  //cm
    else make_LANL_FST_station(Form("FST_%i", i), g4Reco, fwd_z_np[i], fwd_rmin_np[i], fwd_rmax_np[i], 35 * um, 10e-4);  //cm
  }
